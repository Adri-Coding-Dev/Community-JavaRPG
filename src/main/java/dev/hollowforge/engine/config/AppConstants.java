package dev.hollowforge.engine.config;
...
public final class AppConstants {
    ...
    public static final String FONT_MINECRAFT = FONTS_DIR + "HollowForgeMinecraftRegular.otf";
    ...
    public static final double SOCIAL_BUTTON_SIZE = 80;
