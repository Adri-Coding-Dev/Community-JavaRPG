...
import dev.hollowforge.presentation.ui.ContributorsView;
import dev.hollowforge.presentation.ui.MainMenuView;
import dev.hollowforge.presentation.ui.OptionsView;
...
public class SceneManager {
    ...
    private static final int ANCHO_OPCIONES = 400;
    private static final int ALTO_OPCIONES = 350;
    ...
    private void cambiarEscena(Parent root, int ancho, int alto) {
